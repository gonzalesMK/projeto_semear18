...
int main(int argc, char *argv[])
{
    ...
    while (ros::ok())
    {
        ...
        if (nread > 0)
        {
            ...
            msg.data = b[1]; ////(media_movel1[0] + media_movel1[1] + media_movel1[2] + media_movel1[3] + media_movel1[4]) / 5;
            pubLineSensors2.publish(msg);
            msg.data = b[2]; ////(media_movel2[0] + media_movel2[1] + media_movel2[2] + media_movel2[3] + media_movel2[4]) / 5;
            pubLineSensors3.publish(msg);
            msg.data = b[3]; ////(media_movel3[0] + media_movel3[1] + media_movel3[2] + media_movel3[3] + media_movel3[4]) / 5;
            pubLineSensors4.publish(msg);
            msg.data = b[4]; //(media_movel4[0] + media_movel4[1] + media_movel4[2] + media_movel4[3] + media_movel4[4]) / 5;
            pubLineSensors5.publish(msg);
            msg.data = b[5]; //(media_movel5[0] + media_movel5[1] + media_movel5[2] + media_movel5[3] + media_movel5[4]) / 5;
            pubLineSensors6.publish(msg);
            msg.data = b[6]; //(media_movel6[0] + media_movel6[1] + media_movel6[2] + media_movel6[3] + media_movel6[4]) / 5;
            pubLineSensors7.publish(msg);
            msg.data = b[7]; //(media_movel7[0] + media_movel7[1] + media_movel7[2] + media_movel7[3] + media_movel7[4]) / 5;
